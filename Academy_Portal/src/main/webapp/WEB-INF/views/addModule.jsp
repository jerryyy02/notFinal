            ...
            <h2>Module Registration<a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="addModule.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="moduleId" id="moduleId" tabindex="1" class="form-control" placeholder="Module Id" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="moduleName" id="moduleName" tabindex="1" class="form-control" placeholder="Module Name" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="moduleDesc" id="moduleDesc" tabindex="2" class="form-control" placeholder="Module Description">
                  </div>
                  <div class="form-group">
                    <div class="row">
