          ...
          <div class="row">
            ...
            <h2>Batch Allocation <a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="batchAllocation.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="startDate" id="startDate" tabindex="2" class="form-control" placeholder="Start Date" value="">
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="endDate" id="endDate" tabindex="3" class="form-control" placeholder="End Date" value="">
                  </div>
