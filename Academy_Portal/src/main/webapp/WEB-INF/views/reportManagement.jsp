          ...
          <div class="row">
            ...
            <h2>Report Management<a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="reportManagement.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="weeklyReport" id="weeklyReport" tabindex="2" class="form-control" placeholder="Weekly Report" value="">
                  </div>
                   <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="mockTest" id="mockTest" tabindex="3" class="form-control" placeholder="Mock Test" value="">
                  </div>
                  <div class="form-group">
