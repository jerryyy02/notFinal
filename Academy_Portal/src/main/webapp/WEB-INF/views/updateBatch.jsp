             ...
             <form id="login-form" action="updateBatch.html" method="post" role="form" style="display: block;">
               	...
               	<br>
    				...
    				<select name="batchAllocationId">
                          <option value="">Batch Allocation Id
                          </option>
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="closeDate" id="closeDate" tabindex="2" class="form-control" placeholder="Closing Date" value="">
                  </div>
