package com.cts.academy_portal.configuration;
...
@ComponentScans(value = { @ComponentScan("com.cts.academy_portal.dao"),
      @ComponentScan("com.cts.academy_portal.service") })
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
     ...
     // factoryBean.setAnnotatedClasses(Login.class);
      factoryBean.setPackagesToScan("com.cts.academy_portal.bean");
      return factoryBean;
   }
